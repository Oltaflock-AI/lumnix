...
## Lumnix Product Context

**Read these files before starting any work:**
- `LUMNIX_MASTER_PLAN.md` — Full product vision, competitive positioning, five-pillar architecture
- `PHASE0_SPRINT_PLAN.md` — 4-week sprint plan with specific tasks and acceptance criteria

**What Lumnix is:** A full-stack AI marketing platform (not just an analytics dashboard). It combines SEO analytics (GSC), web analytics (GA4), paid ads (Google Ads + Meta Ads), creative studio (swipe files + AI generation), campaign launching, attribution, and an AI agent — all in one platform at $99–299/mo.

**Current state (April 2026):**
- GSC + GA4 integrations: working (OAuth + sync + data display)
- Google Ads: partial (needs developer token approval)
- Meta Ads: in progress (OAuth setup)
- AI Chat: working (GPT-4o-mini with workspace context)
- Competitor tracking + ad scraping: working
- Cron sync: working for GSC + GA4 only (daily at 2 AM UTC)
- Missing: Creative Studio, Campaign Launcher, Attribution pixel, Lumi AI agent, billing

**Current sprint focus:** Beta by April 11, full v1 by May 2. See PHASE0_SPRINT_PLAN.md for daily task breakdown.
